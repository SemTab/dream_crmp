...
import com.dmob.cr.gui.ActionsMenu;
...
import com.dmob.cr.gui.MusicPlayer;
...
import com.dmob.cr.gui.PausMenu;
...
public abstract class NvEventQueueActivity
    ...
    public void showBoombox() {
        runOnUiThread(() -> {
            MusicPlayer.showMusicPlayer(NvEventQueueActivity.this);
        });
    }

    // Метод для отображения меню "Действия"
    public void showActionsMenu() {
        runOnUiThread(() -> {
            com.dmob.cr.gui.ActionsMenu.showActionsMenu(NvEventQueueActivity.this);
        });
    }

    // Метод для скрытия меню "Действия"
    public void hideActionsMenu() {
        runOnUiThread(() -> {
            com.dmob.cr.gui.ActionsMenu.hideActionsMenu();
        });
    }
